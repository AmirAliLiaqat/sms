...
const CanteenSidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  const location = useLocation();
  const { logout } = useAuth();

  const menuItems = [
    { title: "Dashboard", path: "/canteen/dashboard", icon: TrendingUp },
    { title: "Menu Items", path: "/canteen/items", icon: Utensils },
    { title: "Order History", path: "/canteen/history", icon: History },
  ];
