...
const FacultySidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  ...
  const menuItems = [
    ...
    { title: "Student List", path: "/faculty/students", icon: Users },
    { title: "Attendance", path: "/faculty/attendance", icon: ClipboardCheck },
    { title: "Upload Results", path: "/faculty/results", icon: FileText },
    { title: "Assignments", path: "/faculty/assignments", icon: Upload },
    { title: "Time Table", path: "/faculty/timetable", icon: Calendar },
    { title: "Announcements", path: "/faculty/announcements", icon: Bell },
  ];
