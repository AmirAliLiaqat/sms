...
const LibrarySidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  const location = useLocation();
  const { logout } = useAuth();

  const menuItems = [
    { title: "Dashboard", path: "/library/dashboard", icon: Library },
    { title: "Book Management", path: "/library/books", icon: BookOpen },
    { title: "Issue / Return", path: "/library/issue-return", icon: QrCode },
    { title: "History & Fines", path: "/library/history", icon: History },
  ];
