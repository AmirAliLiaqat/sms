...
const ManagementSidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  const location = useLocation();
  const { logout } = useAuth();

  const menuItems = [
    { title: "Overview", path: "/management/dashboard", icon: LayoutDashboard },
    { title: "Finance Summary", path: "/management/finance", icon: PieChart },
    { title: "Reports", path: "/management/reports", icon: FileText },
    { title: "Approvals", path: "/management/approvals", icon: CheckSquare },
    { title: "Staff Directory", path: "/management/staff", icon: Users },
    { title: "Departments", path: "/management/departments", icon: Building2 },
  ];
