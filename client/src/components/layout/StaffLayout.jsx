...
const StaffSidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  const location = useLocation();
  const { logout } = useAuth();

  const menuItems = [
    { title: "My Tasks", path: "/staff/dashboard", icon: CheckSquare },
    { title: "Profile", path: "/staff/profile", icon: User },
    { title: "Attendance", path: "/staff/attendance", icon: ClipboardCheck },
    { title: "Notices", path: "/staff/notices", icon: Bell },
  ];
