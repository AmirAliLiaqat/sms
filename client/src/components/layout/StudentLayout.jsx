...
const StudentSidebar = ({ isOpen, setIsOpen, isCollapsed, toggleCollapse }) => {
  ...
  const menuItems = [
    ...
    { title: "Class Details", path: "/student/class", icon: School },
    { title: "Time Table", path: "/student/timetable", icon: Calendar },
    { title: "Attendance", path: "/student/attendance", icon: ClipboardCheck },
    { title: "Exams & Results", path: "/student/exams", icon: FileText },
    { title: "Fee Status", path: "/student/fees", icon: CreditCard },
    { title: "Library", path: "/student/library", icon: Library },
    { title: "Notices", path: "/student/notices", icon: Bell },
    { title: "Submissions", path: "/student/submissions", icon: Upload },
    { title: "Change Password", path: "/student/change-password", icon: Lock },
  ];
